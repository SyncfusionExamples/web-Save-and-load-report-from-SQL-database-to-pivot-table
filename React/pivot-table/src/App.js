...
export default class App extends Component {
    ...
    saveReport(args) {
        ...
        fetch('https://localhost:44370/Actions/SaveReport', {
            method: 'POST',
            headers: {
    ...
    fetchReport(args) {
        fetch('https://localhost:44370/Actions/FetchReport', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
    ...
    loadReport(args) {
        fetch('https://localhost:44370/Actions/LoadReport', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
    ...
    removeReport(args) {
        fetch('https://localhost:44370/Actions/RemoveReport', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
    ...
    renameReport(args) {
        fetch('https://localhost:44370/Actions/RenameReport', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
